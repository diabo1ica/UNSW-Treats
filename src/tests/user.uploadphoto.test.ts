...
describe('users path tests', () => {
  let token : string;
  const imgUrl = 'https://www.traveller.com.au/content/dam/images/h/1/p/q/1/k/image.related.articleLeadwide.620x349.h1pq27.png/1596176460724.jpg';
  const imgUrlWrong = 'https://www.traveller.com.au/content/dam/images/h/1/p/q/1/k/image.related.articleLeadwide.620x349.h1pq27.png/1596176460724.png';
  beforeEach(() => {
    requestClear();
